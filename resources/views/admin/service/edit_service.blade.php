                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body form">
                            ...
                            {!! Form::open(['url' => '/update-service','class'=>'cmxform form-horizontal','id'=>'signupForm','method'=>'post','enctype'=>'multipart/form-data','name'=>'edit_service']) !!}
                             @csrf
                                <div class="control-group ">
                                    <label for="firstname" class="control-label">Service Name</label>
                                    <div class="controls">
                                        <input class="span6 " id="" name="service_name" type="text" value="{{$service_info->service_name}}" />
                                         <input class="span6 " id="" name="service_id" type="hidden" value="{{$service_info->service_id}}" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea class="span6 " id="" name="service_description" type="text" >{{$service_info->service_description}}</textarea>
                                    </div>
                                </div>
