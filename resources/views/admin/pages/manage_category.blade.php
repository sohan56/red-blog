                         ...
                         <div class="widget-body">
                             <div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info">
                                     <thead>
                                     <tr role="row">
                                        <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="Username" style="width: 193px;">Category Id</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" aria-label="Full Name: activate to sort column ascending" style="width: 288px;">Category Name</th>
                                 ...
                                 <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    ...
                                    <tr class="odd ">
                                         <td class="  sorting_1">{{$v_category->category_id}}</td>
                                         <td class=" ">{{$v_category->category_name}}</td>
                                         <td class=" ">
                                         ...
                                         <td class="center ">
                                            @if($v_category->publication_status==1)
                                            <a href="{{URL::to('/unpublish-category',$v_category->category_id)}}" class="btn btn-danger"><i class="icon-thumbs-down"></i></a>
                                            @else
                                            <a href="{{URL::to('/publish-category',$v_category->category_id)}}" class="btn btn-success"><i class="icon-thumbs-up"></i></a>
                                            @endif
