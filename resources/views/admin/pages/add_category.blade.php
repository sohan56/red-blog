                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body form">
                            ...
                            {!! Form::open(['url' => '/save-category','class'=>'cmxform form-horizontal','id'=>'signupForm','method'=>'post']) !!}
                             @csrf
                                <div class="control-group ">
                                    <label for="firstname" class="control-label">Category Name</label>
                                    <div class="controls">
                                        <input class="span6 " id="" name="category_name" type="text" />
                                    </div>
                                </div>
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea class="span6 " id="" name="category_description" type="text"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
