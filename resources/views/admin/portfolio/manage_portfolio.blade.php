                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i>Manage Portfolio</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered dataTable" id="editable-sample" aria-describedby="editable-sample_info">
                                     <thead>
                                     <tr role="row">
                                        <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="Username" style="width: 193px;">Image</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="editable-sample" rowspan="1" colspan="1" aria-label="Full Name: activate to sort column ascending" style="width: 288px;">Portfolio Title</th>
                                 ...
                                 <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    ...
                                    <tr class="odd ">
                                         <td class="  sorting_1"><img src="{{asset($v_portfolio->img)}}" width="100" height="100" alt="image" /></td>
                                         <td class=" ">{{$v_portfolio->portfolio_title}}</td>
                                         <td class=" ">
                                         ...
                                         <td class="center ">
                                            @if($v_portfolio->publication_status==1)
                                            <a href="{{URL::to('/unpublish-portfolio',$v_portfolio->portfolio_id)}}" class="btn btn-danger"><i class="icon-thumbs-down"></i></a>
                                            @else
                                            <a href="{{URL::to('/publish-portfolio',$v_portfolio->portfolio_id)}}" class="btn btn-success"><i class="icon-thumbs-up"></i></a>
                                            @endif
                                            <a href="{{URL::to('/edit-portfolio',$v_portfolio->portfolio_id)}}" class="btn btn-primary"><i class="icon-pencil"></i></a>
                                            @if(Session::get('access_label')==2)
                                            <a href="{{URL::to('/delete-portfolio',$v_portfolio->portfolio_id)}}" class="btn btn-danger" onclick="return checkDelete()"><i class="icon-trash"></i></a>
                                            @endif
